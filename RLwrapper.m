...
datafileName = ['PRL_ID_' num2str(subjectId) '_SessionNo' num2str(Session) '_Data Folder'];
...
for Exprun=1:3
    ...
    while trialNo <= max(ConditionList.Trial)
...
display(['The participant earned ' num2str(sum(cell2mat(AllResults(:,10)))) ' dollars!']);
